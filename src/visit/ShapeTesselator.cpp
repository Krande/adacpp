...
// OCCT 8.0 pruned transitive includes; both headers exist unchanged in 7.9.3.
...
ShapeTesselator::ShapeTesselator(TopoDS_Shape aShape)
    : myShape(aShape), locVertexcoord(NULL), locNormalcoord(NULL), locTriIndices(NULL), computed(false) {
